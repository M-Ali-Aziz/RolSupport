	...
	function ht_kb_breadcrumb_display( $sep = '<span class="sep">/</span>' ) {
		...
		if (!ht_kb_is_ht_kb_front_page()) { 
			...
			if (!empty($taxonomy) && !empty($term_string)) {
				...
				echo '<a href="' . get_post_type_archive_link( 'ht_kb' ) . '">' . __('Browse by topic', 'ht-knowledge-base') . '</a>' . $sep; 
	...
	*/
	function ht_kb_display_search(){
		...
		<form role="search" method="get" id="searchform" class="searchform" action="<?php echo home_url( '/' ); ?>">
			...
			<button type="submit" id="searchsubmit"><span><?php _e( 'Search', 'ht-knowledge-base' ); ?></span></button>
		</form>
		<?php
	} //end function
}//end function exists
